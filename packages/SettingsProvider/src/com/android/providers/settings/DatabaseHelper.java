...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadVibrateSetting(SQLiteDatabase db, boolean deleteOld) {
        ...
        try {
            ...
            //Modified by chenqiang for ROM#4664,20120410
            // Vibrate on by default for ringer and notification
            int vibrate = 0;
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadBooleanSetting(stmt, Settings.System.NOTIFICATION_LIGHT_PULSE,
                    R.bool.def_notification_pulse);
            // Begin, Modified by zhumeiquan, changed default value for settings, 20111121
            ...
            // Author by Fanzhong ,modifed by ioz9
            // TEMP Load initial SensorSettings
            // Remove these Settings When we solved light sensor problem later
//            if("TD".equalsIgnoreCase(SystemProperties.get(SYSTEM_SETTING_LIGHT_TEMP_SETTINGS)))
//                loadTempLightSensorSettings(stmt);
    ...
    // Author by Fanzhong ,modifed by ioz9
    /*
    *private void loadTempLightSensorSettings(SQLiteStatement stmt){
    *    loadSetting(stmt, Settings.System.LIGHT_FILTER, 1);
    *    loadSetting(stmt, Settings.System.LIGHT_FILTER_WINDOW, 5000);
    *    loadSetting(stmt, Settings.System.LIGHT_FILTER_INTERVAL, 1000);
    *    loadSetting(stmt, Settings.System.LIGHT_SENSOR_CUSTOM, 1);
    *    loadSetting(stmt, Settings.System.LIGHT_DECREASE, 1);
    *    loadSetting(stmt, Settings.System.LIGHT_HYSTERESIS, 20);
    *    loadSetting(stmt, Settings.System.LIGHTS_CHANGED, 1);
    }*/
}
