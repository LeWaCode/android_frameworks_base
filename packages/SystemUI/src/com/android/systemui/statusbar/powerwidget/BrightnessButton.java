...
public class BrightnessButton extends PowerButton {
    ...
    private int[] BACKLIGHTS /*= new int[] {
    ...
    protected void setupButton(View view) {
        ...
        if (mView != null) {
            ...
            if (mAutoBrightnessSupported) {
                BACKLIGHTS = new int[] { AUTO_BACKLIGHT, MIN_BACKLIGHT, MID_BACKLIGHT, 
                    MAX_BACKLIGHT};
                mBacklightValues = new int[] {0, 1, 2, 3};
            } else {
                BACKLIGHTS = new int[] {MIN_BACKLIGHT, MID_BACKLIGHT, 
                    MAX_BACKLIGHT};
                mBacklightValues = new int[] {0, 1, 2};
            }
            updateSettings();
        }
    }
    ...
    private void updateSettings() {
		...
		// add not support auto brightness
	if (mAutoBrightnessSupported) {
