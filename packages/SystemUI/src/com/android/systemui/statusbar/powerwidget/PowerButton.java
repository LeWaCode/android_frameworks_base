...
import android.widget.TextView;//added by zhangbo
...
public abstract class PowerButton {
    ...
    public static final String BUTTON_VIBRATE = "toggleWimax";//added by zhangbo
    public static final String BUTTON_POWER_OFF = "togglePoweroff";
    public static final String BUTTON_REBOOT = "toggleReboot";
    public static final String BUTTON_LOCK_SCREEN = "toggleLockscreen";
    ...
    static {
        ...
        BUTTONS.put(BUTTON_VIBRATE, VibrateButton.class);//added by zhangbo
	 BUTTONS.put(BUTTON_POWER_OFF, PoweroffButton.class);
	 BUTTONS.put(BUTTON_REBOOT, RebootButton.class);
	 BUTTONS.put(BUTTON_LOCK_SCREEN, MyLockscreenButton.class);
	 BUTTONS.put(BUTTON_NIGHT_MODE, NightmodeButton.class);
    }
    //added by zhangbo 
    private static final HashMap<String, Integer> BUTTONSTEXT = new HashMap<String, Integer>();
    static {
    	BUTTONSTEXT.put(BUTTON_WIFI, R.string.wifi);
    	BUTTONSTEXT.put(BUTTON_GPS, R.string.gps);
    	BUTTONSTEXT.put(BUTTON_BLUETOOTH, R.string.bluetooth);
    	BUTTONSTEXT.put(BUTTON_BRIGHTNESS, R.string.brightness);
    	BUTTONSTEXT.put(BUTTON_SOUND, R.string.sound);
    	BUTTONSTEXT.put(BUTTON_SYNC, R.string.sync);
    	BUTTONSTEXT.put(BUTTON_WIFIAP, R.string.wifiap);
    	BUTTONSTEXT.put(BUTTON_SCREENTIMEOUT, R.string.screentimeout);
    	BUTTONSTEXT.put(BUTTON_MOBILEDATA, R.string.mobiledata);
    	BUTTONSTEXT.put(BUTTON_LOCKSCREEN, R.string.lockscreen);
    	BUTTONSTEXT.put(BUTTON_NETWORKMODE, R.string.networkmode);
    	BUTTONSTEXT.put(BUTTON_AUTOROTATE, R.string.autorotate);
    	BUTTONSTEXT.put(BUTTON_AIRPLANE, R.string.airplane);
    	BUTTONSTEXT.put(BUTTON_FLASHLIGHT, R.string.flashlight);
    	BUTTONSTEXT.put(BUTTON_SLEEP, R.string.sleep);
    	BUTTONSTEXT.put(BUTTON_MEDIA_PLAY_PAUSE, R.string.play_pause);
    	BUTTONSTEXT.put(BUTTON_MEDIA_PREVIOUS, R.string.previous);
    	BUTTONSTEXT.put(BUTTON_MEDIA_NEXT, R.string.next);
    	BUTTONSTEXT.put(BUTTON_WIMAX, R.string.wimax);
    	BUTTONSTEXT.put(BUTTON_VIBRATE, R.string.vibrate);
	BUTTONSTEXT.put(BUTTON_POWER_OFF, R.string.poweroff);
	BUTTONSTEXT.put(BUTTON_REBOOT, R.string.reboot);
	BUTTONSTEXT.put(BUTTON_LOCK_SCREEN, R.string.mylockscreen);
	BUTTONSTEXT.put(BUTTON_NIGHT_MODE, R.string.power_widgetbutton_nightmode);
    }
    ...
    protected TextView mTextView;//added by zhangbo
    ...
    private Handler mViewUpdateHandler = new Handler() {
            public void handleMessage(Message msg) {
                ...
                if(mView != null) {
                    ...
                    /* Button State *///modify by zhangbo
                    /*switch(mState) {
                        case STATE_ENABLED:
    ...
    protected void setupButtonText(View view, int resId) {//added by zhangbo
        mView = view;
        mTextView = (TextView)mView.findViewById(R.id.buttontext);
    ...
    private View.OnLongClickListener mLongClickListener = new View.OnLongClickListener() {
        public boolean onLongClick(View v) {
            ...
            //return result;//modified by zhangbo
	      return true;
        }
    };
            ...
            synchronized (BUTTONS_LOADED) {
                if(BUTTONS_LOADED.containsKey(key)) {
                    ...
                    try {
                        ...
                        int textres = BUTTONSTEXT.get(key);//added by zhangbo
                        pb.setupButtonText(view, textres);
    ...
    //added by zhangbo
    public View.OnLongClickListener getGlobalOnLongClickListener() {
        return GLOBAL_ON_LONG_CLICK_LISTENER;
    }
