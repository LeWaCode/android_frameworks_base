...
public class StatusBarView extends FrameLayout {
    ...
    View mDate;
    View mCarrier;//modified by zhangbo
    View mClock;
    ...
    protected void onFinishInflate() {
        ...
        //mStatusIcons.setPadding(0, 0, 6, 0);
        mDate = findViewById(R.id.date);
        mCarrier = findViewById(R.id.carrier);//modified by zhangbo
        mClock = findViewById(R.id.clock);
        //mBackground = new FixedSizeDrawable(mDate.getBackground());
        //mBackground = new FixedSizeDrawable(mCarrier.getBackground());
        //mBackground.setFixedBounds(0, 0, 0, 0);
        //mDate.setBackgroundDrawable(mBackground);
       // mCarrier.setBackgroundDrawable(mBackground);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int oldDateRight = mCarrier.getRight();//modified by zhangbo
        int newDateRight;
        ...
        mCarrier.layout(mCarrier.getLeft(), mCarrier.getTop(), newDateRight, mCarrier.getBottom());//modified by zhangbo
        //mBackground.setFixedBounds(-mCarrier.getLeft(), -mCarrier.getTop(), (r-l), (b-t));
        /*if (mClock.getRight() +  mClock.getPaddingRight() > max) {
            int dx = (mClock.getRight() +  mClock.getPaddingRight() - max);
            mStatusIcons.layout(mStatusIcons.getLeft(), mStatusIcons.getTop(), mStatusIcons.getRight() - dx, mStatusIcons.getBottom());
            mDate.layout(mDate.getLeft()- dx, mDate.getTop(), mDate.getRight() - dx, mDate.getBottom());
            mClock.layout(mClock.getLeft()- dx, mClock.getTop(), mClock.getRight() - dx, mClock.getBottom());
        }*/
    }
