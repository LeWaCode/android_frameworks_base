...
public class StorageNotification extends StorageEventListener {
    ...
    // Begin, Added by zhumeiquan for new req #5492, 20120601
...
/*             //prevent from  dup icon 
        ...
        // Begin, Deleted by zhumeiquan for new req #5492, 20120601    
        ...
        */
        final int notificationId = mUsbStorageNotification.icon;
        mUsbStorageNotification.setTag(mUsbTagFlag);
        //ended
    ...
    private synchronized void setMediaStorageNotification(int titleId, int messageId, int icon, boolean visible,
        ...
        * 
        */
        mMediaStorageNotification.setTag(mUsbTagFlag);
