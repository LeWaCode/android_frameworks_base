...
import android.lewa.animation.Animator;
import android.lewa.animation.AnimatorListenerAdapter;
import android.lewa.animation.ObjectAnimator;
import android.lewa.animation.PropertyValuesHolder;
import android.lewa.animation.TimeInterpolator;
import android.lewa.animation.Animator.AnimatorListener;
import android.lewa.animation.ValueAnimator.AnimatorUpdateListener;
