...
//	public static final String COLUMN_BLACK          = "black";
	...
	public static final Uri CONTENT_URI     = Uri.parse("content://" + AUTOHORITY + "/interceptData");
	
	public static final Uri DND_CONTENT_URI = Uri.parse("content://" + AUTOHORITY + "/dnd");
	
	public static final Uri MSG_CONTENT_URI = Uri.parse("content://" + AUTOHORITY + "/msg_history");
	
	public static final Uri CALL_CONTENT_URI = Uri.parse("content://" + AUTOHORITY + "/call_history");
